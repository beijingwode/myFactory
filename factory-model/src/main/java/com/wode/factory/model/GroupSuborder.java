...
@Table("t_group_suborder")
public class GroupSuborder extends BaseModel implements java.io.Serializable{
	...
	/**
     * 合单之前realPrice       db_column: now_totalProduct  
     * 
     * 
     * 
     */	
	@Column("beforeOpen_realPrice")
	private BigDecimal beforeOpenRealPrice;
	/**
     * 合单之前运费       db_column: now_totalShipping  
     * 
     * 
     * 
     */	
	@Column("now_totalShipping")
	private BigDecimal nowTotalShipping;
	/**
     * 合单之后realPrice        db_column: afterOpen_realPrice  
     * 
     * 
     * 
     */	
	@Column("afterOpen_realPrice")
	private BigDecimal afterOpenRealPrice;
	@Column("refuseNote")
	...
	private Integer limitTicketCnt;//使用优惠券张数
	...
	public BigDecimal getBeforeOpenRealPrice() {
		return beforeOpenRealPrice;
	}

	public void setBeforeOpenRealPrice(BigDecimal beforeOpenRealPrice) {
		this.beforeOpenRealPrice = beforeOpenRealPrice;
	}

	public BigDecimal getNowTotalShipping() {
		return nowTotalShipping;
	}

	public void setNowTotalShipping(BigDecimal nowTotalShipping) {
		this.nowTotalShipping = nowTotalShipping;
	}

	public BigDecimal getAfterOpenRealPrice() {
		return afterOpenRealPrice;
	}

	public void setAfterOpenRealPrice(BigDecimal afterOpenRealPrice) {
		this.afterOpenRealPrice = afterOpenRealPrice;
	}
	...
	private List<GroupSuborderitem> groupsuborderitemlist;//子订单购买的商品列表
	...
	public boolean equals(Object obj) {
		if(obj instanceof GroupSuborder == false) return false;
		if(this == obj) return true;
		GroupSuborder other = (GroupSuborder)obj;
