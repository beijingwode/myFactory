...
@Table("t_group_orders")
public class GroupOrders extends BaseModel implements java.io.Serializable{
	 ...
	 */
	@Column("now_shipping")
	private BigDecimal nowShipping;
	/**
	 * 现在所需总运费
	 */
	@Column("now_total_shipping")
	...
	//columns END
	private List<GroupSuborder> items;

	public List<GroupSuborder> getItems() {
		return items;
	}

	public void setItems(List<GroupSuborder> items) {
		this.items = items;
	}
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("SaveAmount",getSaveAmount())
			.toString();
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof GroupOrders == false) return false;
		if(this == obj) return true;
		GroupOrders other = (GroupOrders)obj;
	...
	public BigDecimal getNowShipping() {
		return nowShipping;
	}

	public void setNowShipping(BigDecimal nowShipping) {
		this.nowShipping = nowShipping;
	}
