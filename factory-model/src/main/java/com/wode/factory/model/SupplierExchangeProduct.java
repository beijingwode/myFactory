 ...
 *
 */
@Table("t_supplier_exchange_product")
public class SupplierExchangeProduct extends BaseModel implements java.io.Serializable{

    /**
	 * 
	 */
	private static final long serialVersionUID = -4164974216779639814L;
	//columns START
    /**
     * id       db_column: id
     * 
    ...
    @Column("sample_amount")
    private java.math.BigDecimal sampleAmount;//换领币总额
    
    @Column("cash_amount")
    private java.math.BigDecimal cashAmount;//现金总额
    
    private Integer reservedNum;//已预订
    private Integer exchangeSuNum;//已换领
	...
	public java.math.BigDecimal getSampleAmount() {
		return sampleAmount;
	}

	public void setSampleAmount(java.math.BigDecimal sampleAmount) {
	...
	public Integer getExchangeSuNum() {
		return exchangeSuNum;
	}

	public void setExchangeSuNum(Integer exchangeSuNum) {
		this.exchangeSuNum = exchangeSuNum;
	}
