...
@Table("t_settle_accounts")
public class SettleAccounts extends BaseModel implements java.io.Serializable{
	...
	//date formats
	public static final String FORMAT_MONTH = DATE_TIME_FORMAT;
	public static final String FORMAT_COMMISSION = DATE_TIME_FORMAT;
	...
	public String getMonthString() {
		return DateConvertUtils.format(getMonth(), FORMAT_MONTH);
	}
	public void setMonthString(String value) {
		setMonth(DateConvertUtils.parse(value, FORMAT_MONTH,java.util.Date.class));
	}
