...
@Table("t_user_black_envelope_item")
public class UserBlackEnvelopeItem extends BaseModel implements java.io.Serializable{

	public UserBlackEnvelopeItem(){
		
	}
	public UserBlackEnvelopeItem(UserBlackEnvelopeItem copy){
		this.envelopeId=copy.envelopeId;
		this.allotType=copy.allotType;
		this.currencyId=copy.currencyId;
		this.orders=copy.orders;
		this.price=copy.price;
		this.fromId=copy.fromId;
		this.fromNike=copy.fromNike;
		this.userId=copy.userId;
		this.status=copy.status;
		this.updateTime=copy.updateTime;
		this.userNike=copy.userNike;
		this.userAvatar=copy.userAvatar;
		this.flowCd=copy.flowCd;
