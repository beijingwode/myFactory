...
@Table("t_shipping_address")
public class ShippingAddress extends BaseModel implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "ShippingAddress";
	...
	public boolean equals(Object obj) {
		if(obj instanceof ShippingAddress == false) return false;
