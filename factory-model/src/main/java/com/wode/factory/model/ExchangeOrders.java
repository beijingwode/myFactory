...
@Table("t_exchange_orders")
public class ExchangeOrders extends BaseModel implements java.io.Serializable{
	...
	//columns END
	private List<ExchangeSuborder> items;
	

	public List<ExchangeSuborder> getItems() {
		return items;
	}

	public void setItems(List<ExchangeSuborder> items) {
		this.items = items;
	}

	public ExchangeOrders(){
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ExchangeOrders == false) return false;
		if(this == obj) return true;
		ExchangeOrders other = (ExchangeOrders)obj;
