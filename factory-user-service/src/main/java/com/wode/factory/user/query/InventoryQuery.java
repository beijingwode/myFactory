...
public class InventoryQuery extends BaseQuery implements Serializable {
	...
	/** 预警值 */
	private java.lang.Integer warnQuantity;
	...
	public java.lang.Integer getWarnQuantity() {
		return this.warnQuantity;
	}
	
	public void setWarnQuantity(java.lang.Integer value) {
		this.warnQuantity = value;
	}
