...
public class PromotionProductQuery extends BaseQuery implements Serializable {
	...
	/** 优惠数字  0.15  根据preferential_type来判定为 0.15元 还是0.15折 */
	private Long preferentialNum;
	/** 优惠类型：1：元   2：折 */
	...
	public Long getPreferentialNum() {
		return this.preferentialNum;
	}
	
	public void setPreferentialNum(Long value) {
		this.preferentialNum = value;
	}
