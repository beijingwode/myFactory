...
<div class="clearfix">
	<div style="float: left;">
		<div style="padding-top:5px;">
			...
			@if(message != null){
			<p style="font-size:12px; display: inline-block; margin-left:10px;cursor: pointer;" id="addContent" ><span style="font-family:'微软雅黑 Bold', '微软雅黑 Regular', '微软雅黑';font-weight:700;color:#69AA46;font-size:20px;">+</span><span style="font-family:'微软雅黑';font-weight:400;font-size:12px;color:#0000FF;">${message}</span></p>
			@}
		</div>
	</div>
	<div>
...
<div style="float: left;">
	<div style="padding-top:5px;">
		<p style="font-size:20px;cursor: pointer;" id="addContent"><span style="font-family:'微软雅黑 Bold', '微软雅黑 Regular', '微软雅黑';font-weight:700;color:#69AA46;">+</span><span style="font-family:'微软雅黑';font-weight:400;font-size:13px;color:#0000FF;">${message}</span></p>
	</div>
</div>
@}
@}