package com.wode.common.spring.aspect;
...
import com.wode.common.spring.annotation.Log;
import com.wode.common.util.IPUtils;
import com.wode.sys.model.SysLog;
import com.wode.sys.service.SysLogService;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.wode.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.wode.*Service.*(..))")
