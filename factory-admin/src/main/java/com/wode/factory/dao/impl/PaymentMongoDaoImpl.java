...
@Repository("paymentMongoDao")
public class PaymentMongoDaoImpl extends FactoryMongoBase<Payment> implements PaymentMongoDao {
	...
	@Override
	public Document toDocment(Payment obj) {
	...
	@Override
	public Bson getFilter(Payment newdoc) {
		return null;
	}
	
	@Override
	public Payment query2Bean(BaseQuery newdoc) {
		return null;
	}
	
	@Override
	public Payment initBean(Document doc) {
		return null;
	}
}
