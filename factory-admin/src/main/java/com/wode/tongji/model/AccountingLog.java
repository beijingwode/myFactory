...
public class AccountingLog extends BaseModel implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "AccountingLog";
	...
	public boolean equals(Object obj) {
		if(obj instanceof AccountingLog == false) return false;
		if(this == obj) return true;
		AccountingLog other = (AccountingLog)obj;
