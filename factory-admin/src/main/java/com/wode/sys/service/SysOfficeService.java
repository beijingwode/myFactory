...
import com.wode.sys.mapper.SysOfficeMapper;
import com.wode.sys.mapper.SysRoleMapper;
...
public class SysOfficeService extends ServiceMybatis<SysOffice> {
	...
	public int saveSysOffice(SysOffice sysOffice){
		...
		SysUserUtils.clearCacheOffice(Lists.newArrayList(SysUserUtils.getLoginUser().getId()));
		return count;
	}
