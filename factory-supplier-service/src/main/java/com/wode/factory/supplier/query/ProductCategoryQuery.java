...
public class ProductCategoryQuery extends BaseQuery implements Serializable {
	...
	/** 子节点在兄弟节点中的排行 */
	private java.lang.Integer brotherOrder;
	/** 父节点的子节点数量 */
	...
	public java.lang.Integer getBrotherOrder() {
		return this.brotherOrder;
	}
	
	public void setBrotherOrder(java.lang.Integer value) {
		this.brotherOrder = value;
	}
