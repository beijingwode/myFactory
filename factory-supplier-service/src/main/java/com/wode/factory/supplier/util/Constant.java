...
public class Constant {
	...
	//文件上传路径
	public static String EXCEL_UPLOAD_PATH = res.getString("excel.upload.dir");
	//系统domain
	...
	//excel上传路径
	public static String EXCEL_UPLOAD_URL = res.getString("excel.upload.dir");
	//zip文件夹上传路径
	public static String ZIP_UPLOAD_URL = res.getString("zip.upload.dir");
	//excel输出路径
	public static String EXCEL_OUTPUT = res.getString("excel.output");
	//商品上传zip文件解压路径
	public static String PRODUCT_ZIP_OUTPUT = res.getString("product.zip.output");
	//商品上传zip文件解压路径
	public static String FACTORY_API_URL = res.getString("factory.api.url");
	public static String FACTORY_WEB_URL = res.getString("factory.web.url");
 	public static String CREATHTML_API_URL = res.getString("front.creat_htmlurl");
	//运营后台url
