	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'14px',height:'14px',lineHeight:'14px',fontSize:'10px',background:"#4a4a4a",border:"1px solid #4a4a4a",color:"#fff",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
								focus:{background:"#ff6161",border:"1px solid #ff6161",color:"#fff"}
							},
			...
			var cssCode = '<style type="text/css">';
				...
				if(options.button.normal.display!='none'){
					cssCode+= k.selector+' .'+k.prename+'button{'+k.fn.objToCss(options.button.normal,['top','right','bottom','left'],true)+';list-style:none;z-index:2;}';				
