...
<form id="pageForm" action="" method="get">
    <input type="hidden" id="pageNum" name="page" value="${page.pageNum}"/>
    <div class="page">
...
<script type="text/javascript">
    var url = location.search.substring(1), params = url.split("&");
    $.each(params, function(index,item){
       var param = item.split("=");
        if (param[0] != 'page')
        $("#pageNum").before($('<input type="hidden" name="'+param[0]+'" value="'+param[1]+'" />'));
    });
    function goto(page) {
        $("#pageNum").val(page);
        $("#pageForm").submit();
