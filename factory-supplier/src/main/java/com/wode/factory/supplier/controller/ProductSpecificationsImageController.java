...
@Controller
@RequestMapping("productSpecificationsImage")
public class ProductSpecificationsImageController extends BaseSpringController{
	...
	public ProductSpecificationsImageController() {
	}
