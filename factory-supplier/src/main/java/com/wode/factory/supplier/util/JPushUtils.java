...
public class JPushUtils {
	...
	public boolean sendNotification(String alert, String title,
			Map<String, String> extras, String pushDriver, String pushType,
			String pushName) {
		return push.sendNotification(JPushService.APP_TYPE_SHOP, alert, title, extras, pushDriver, pushType, pushName, false, null);
	}
	...
	public boolean sendMessage(String msgContent, String title,Map<String, String> extras,
			String pushDriver, String pushType,String statusId , String pushName) {
		return push.sendMessage(JPushService.APP_TYPE_SHOP, msgContent, title,extras, pushDriver, pushType, statusId, pushName, false, null);
	}
	/**
	 * 功能说明：推送通知(群推)
	 * 日期:	2015年3月13日
