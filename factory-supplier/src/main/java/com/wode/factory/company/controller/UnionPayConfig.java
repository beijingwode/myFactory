...
public class UnionPayConfig {
	...
	public static final String REDIRECT_URL = "http://supplier.wd-w.com/unionpay/front";

	public static final String NOTIFY_URL = "http://supplier.wd-w.com/unionpay/back";
