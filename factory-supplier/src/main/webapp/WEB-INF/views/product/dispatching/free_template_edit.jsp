...
<div id="content">
    ...
    <div class="left">
        <ul class="left_list">
            ...
            <li class="curr"><a href="${basePath}/shippingAddress/freight_templates.html?ty=1">运费模板</a></li>
    ...
    <div class="right">
        <div class="position">
            ...
            <a href="${basePath}/shippingAddress/todeliver.html">运费模板</a>
        </div>
        <div class="sale_wrap">
             <div class="add_form"><!-- 新增运费模板内容 -->
             	 <div class="form_tit"><c:if test="${empty freelist}">新增</c:if><c:if test="${not empty freelist}">编辑</c:if>全场包邮策略</div>
       			 <form id="sub_free_form" method="post">
       			 	<input type="hidden" name="templateId" value="${supplierTemplateId}" />
             	  <!--指定条件包邮可选-->
		        <div class="ex_postage">
        	  		<div><label for="freeRule">指定全场包邮策略条件</label></div>
					...
					<thead>
						...
						<tr>   
							<td class="con_td1"><span>未添加地区</span>
							<div onclick="showArea(this,'free_');"><a href="javascript:void(0);">编辑</a></div> 
							<input type="hidden" name="free_areasName"  value=""/> 
							<input type="hidden" name="free_areasCode" value=""/>
							</td>
				...
				<div class="slt_wh">
							...
							<div class="inp_text_wh">
     	  	  			    <input type="hidden" name="free_param1" value="0" />满&nbsp;<input type="text" name="free_param2" value="" maxlength="6" />&nbsp;元包邮
							</div>
				</div>
							</td>
             	...
             	<div class="ex_postage">	
					...
					<tbody>
					     <c:forEach items="${freelist}" var="i" varStatus="status">
						<tr>
							<td class="con_td1"><span>${i.areasName}</span>
							<div onclick="showArea(this,'free_');"><a href="javascript:void(0);">编辑</a></div> 
				...
				<div class="inp_text_wh">
						<c:if test="${i.countTypeDes=='1'}">
       	  	  				满&nbsp;<input type="text" name="free_param1" value="${i.param1}" maxlength="6" />&nbsp;件包邮 <input type="hidden" name="free_param2" value="0" />
						</c:if>
						<c:if test="${i.countTypeDes=='2'}">
							<input type="hidden" name="free_param1" value="0" />满&nbsp;<input type="text" name="free_param2" value="${i.param2}" maxlength="6" />&nbsp;元包邮	 
						</c:if>
             ...
             <div class="popup_btn" style="padding-bottom:20px;">
                 <a href="javascript:formFreeSubmit();" >保存并返回</a>
                 <a href="${basePath}/shippingAddress/freight_templates.html" >取消</a>
             </div>
    </div>
    <!--right end-->
</div>
