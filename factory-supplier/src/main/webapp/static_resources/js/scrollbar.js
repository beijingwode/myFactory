...
CM2.intro = {
	start: function() {
		if ($('#dv_scroll_02').length) CM2.intro.iniScr();
	}
	,
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;
		scroller  = new Scrolling.Scroller(document.getElementById('dv_scroll_02'), 430, 209);
		scrollbar = new Scrolling.Scrollbar(document.getElementById('dv_scroll_bar_02'), scroller, new Scrolling.ScrollTween());
}
};
...
CM3.intro = {
	start: function() {
		if ($('#dv_scroll_03').length) CM3.intro.iniScr();
	}
	,
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;
		scroller  = new Scrolling.Scroller(document.getElementById('dv_scroll_03'), 430, 209);
		scrollbar = new Scrolling.Scrollbar(document.getElementById('dv_scroll_bar_03'), scroller, new Scrolling.ScrollTween());
}
};
...
CM4.intro = {
	start: function() {
		if ($('#shopping_dv_scroll').length) CM4.intro.iniScr();
	}
	,
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;
		scroller  = new Scrolling.Scroller(document.getElementById('shopping_dv_scroll'), 430, 209);
		scrollbar = new Scrolling.Scrollbar(document.getElementById('shopping_dv_scroll_bar'), scroller, new Scrolling.ScrollTween());
}
};
var CM5 = {};
CM5.intro = {
	start: function() {
		if ($('#sort_dv_scroll').length) CM5.intro.iniScr();
	}
	,
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;
		scroller  = new Scrolling.Scroller(document.getElementById('sort_dv_scroll'), 430, 209);
		scrollbar = new Scrolling.Scrollbar(document.getElementById('sort_dv_scroll_bar'), scroller, new Scrolling.ScrollTween());
}
};
////////////////////  start  ////////////////////
$(function() {
