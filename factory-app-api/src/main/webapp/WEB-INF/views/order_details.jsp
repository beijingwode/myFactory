...
<link rel="stylesheet" type="text/css" href="<%=static_resources %>css/details.css?111" />
...
<script type="text/javascript" src="<%=static_resources %>js/order_details.js?3"></script>
...
<div class="main-cont" id="main-cont">
    ...
    <div class="main-box" style="position: absolute;top: 6px;">
        ...
        <div class="tel"><a href="javascript:void(0);">联系商家</a></div>
