...
<body>
	<div class="main-cont" id="main-cont">
		<div class="top_box">
			<div class="top">
				<h1>
					<a href="javascript:close();" class="aleft"></a> 试用商品问卷调查
				</h1>
			</div>
		</div>
		<div class="main-box">
			<dl>
				<dt>
					...
					<a href="#" target="_blank"><img src="${q.productImg}" /></a>
				</dt>
				<dd>
					<a href="#" target="_blank">${q.productName}</a>
				</dd>
			</dl>
			<div class="top_tit">
				<span>请您回答以下问卷，获得商家提供的优惠</span>
				<p>该商品需要回答商家提供的问卷才能下单，感谢您的积极配合</p>
			</div>
			<div class="main_con">

				<input type="hidden" id="userId" value="${userId}" /> 
				<input type="hidden" id="questionnareId" value="${q.id}" />
