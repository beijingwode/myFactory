...
<link rel="stylesheet" type="text/css" href="<%=static_resources %>css/details.css?222" />
<link rel="stylesheet" type="text/css" href="<%=static_resources %>css/special_orderDetail.css?33"/>
<script type="text/javascript" src="<%=static_resources %>js/common/system_config.js"></script>
<script type="text/javascript" src="<%=static_resources %>js/wxGetUid.js?1213"></script>
<script type="text/javascript" src="<%=static_resources %>js/jquery1.8.0.js"></script>
<script type="text/javascript" src="<%=static_resources %>js/order_detailsEx.js?2"></script>
<script type="text/javascript" src="<%=static_resources %>js/nochange_font.js"></script>
<script type="text/javascript" src="<%=static_resources %>js/nochange_font.js?3333"></script>
