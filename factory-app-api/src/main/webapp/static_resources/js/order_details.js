...
function ajaxOrderDeatilsData(){
	...
	$.ajax({
		...
		success : function(data) {
			...
			var limitTicketInfo = data.data.suborderLimitTicket;//订单使用优惠信息
			...
			if (result!=null) {
				...
				if (subOrderItems.length>0) {
					...
					for (var i = 0; i < subOrderItems.length; i++) {
						...
						if (subOrderItems[i].benefitType && subOrderItems[i].benefitType==3) {
							$("#hlj").show();
						}else{
							$("#hlj").hide();
						}
					...
					//换领券
					$("#hlj span").html("换领币(使用"+totalHLJ.toFixed(2)+")")
					...
					//优惠券
					if(limitTicketInfo && limitTicketInfo!=null){
						if(limitTicketInfo.totalBenefitCash && limitTicketInfo.totalBenefitCash>0)
						$("#Payable").after('<p><span>优惠券</span><i class="realPay">-￥'+limitTicketInfo.totalBenefitCash.toFixed(2)+'</i></p>');
					}
					//实付金额
					...
					var html='';
					if (result.status==0) {//待支付
						var cashPay = result.cashPay;
						if (cashPay==''||typeof(cashPay)==undefined) {
							cashPay=0;
						}
						var any = result.realPrice-cashPay;
						html +='<div class="order_btn"><a href="javascript:go2Pay(\''+result.subOrderId+'\',\''+any+'\',\''+result.status+'\');" class="btn_ren">付款</a><a href="javascript:go2Cancel(\''+result.subOrderId+'\');" class="btn_ren">取消</a></div>';
					}else if(result.status==1){//待发货
						html+='<div class="order_btn" id="order_btn">';
						if (result.stockUp==1) {
							if (result.selfDelivery==1) {
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">自提•收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else{
								html +='<a href="javascript:void(0);" class="btn_ren">备货中</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}
						}else{
							if (result.selfDelivery==1) {
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">自提•收货</a><a href="javascript:go2Cancel(\''+result.subOrderId+'\');" class="btn_ren">取消</a><a href="javascript:go2more(0);" class="specialtreat">更多</a>';
							}else{
								html +='<a href="javascript:go2TX(\''+result.subOrderId+'\');" class="btn_ren">提醒发货</a><a href="javascript:go2Cancel(\''+result.subOrderId+'\');" class="btn_ren">取消</a><a href="javascript:go2more(0);" class="specialtreat">更多</a>';
							}
						}
						html+='</div>'
					}else if(result.status==2){//待收货
						html += '<div class="order_btn" id="order_btn">';
						if (result.userExetendCount>0&&result.userExetendCount!=undefined) {
							if (result.selfDelivery==1) {
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else if(result.expressType=='14660000000000000'||result.expressType=='14660000000000001'){
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else{
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2CKShipping(\''+result.subOrderId+'\',\''+result.expressType+'\',\''+result.expressNo+'\');" class="btn_ren">查看物流</a><a href="javascript:go2more(\''+result.status+'\');"class="specialtreat">更多</a>';
							}
						}else{
							if (result.selfDelivery==1) {
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2YC(\''+result.subOrderId+'\');" class="btn_ren">延长收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else if(result.expressType=='14660000000000000'||result.expressType=='14660000000000001'){
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2YC(\''+result.subOrderId+'\');" class="btn_ren">延长收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else{
								html +='<a href="javascript:go2Confirm(\''+result.subOrderId+'\');" class="btn_ren">确认收货</a><a href="javascript:go2CKShipping(\''+result.subOrderId+'\',\''+result.expressType+'\',\''+result.expressNo+'\');" class="btn_ren">查看物流</a><a href="javascript:go2YC(\''+result.subOrderId+'\');" class="btn_ren">延长收货</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}
						}
						html+='</div>'
					}else if(result.status==4){//待评价
						html+='<div class="order_btn" id="order_btn">';
						if (result.commentStatus==''||result.commentStatus==0) {
							if (result.selfDelivery==1) {
								html +='<a href="javascript:go2PJ(\''+result.subOrderId+'\');" class="btn_ren">评价</a><a href="javascript:go2Service(\''+result.subOrderId+'\',\''+result.realPrice+'\',\''+result.commentStatus+'\');" class="btn_ren">申请售后</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else if(result.expressType=='14660000000000000'||result.expressType=='14660000000000001'){
								html +='<a href="javascript:go2PJ(\''+result.subOrderId+'\');" class="btn_ren">评价</a><a href="javascript:go2Service(\''+result.subOrderId+'\',\''+result.realPrice+'\',\''+result.commentStatus+'\');" class="btn_ren">申请售后</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}else{
								html +='<a href="javascript:go2PJ(\''+result.subOrderId+'\');" class="btn_ren">评价</a><a href="javascript:go2CKShipping(\''+result.subOrderId+'\',\''+result.expressType+'\',\''+result.expressNo+'\');" class="btn_ren">查看物流</a><a href="javascript:go2Service(\''+result.subOrderId+'\',\''+result.realPrice+'\',\''+result.commentStatus+'\');" class="btn_ren">申请售后</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
							}
						}else{
							html +='<a href="javascript:go2Service(\''+result.subOrderId+'\',\''+result.realPrice+'\',\''+result.commentStatus+'\');" class="btn_ren">申请售后</a><a href="javascript:go2more(\''+result.status+'\');" class="specialtreat">更多</a>';
						}
						html+='</div>'
					}else if(result.status==11){//退货退款完毕
						html +='<div class="order_btn"><a href="javascript:void(0);">退货退款成功</a></div>';
					}else if(result.status==12){//仅退款完毕
						html +='<div class="order_btn"><a href="javascript:void(0);">仅退款成功</a></div>';
					}else if(result.status==3){//退货退款
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">售后详情</a><a href="javascript:void(0);">退货退款中</a></div>';
					}else if(result.status==5){//仅退款
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">售后详情</a><a href="javascript:void(0);">仅退款中</a></div>';
					}else if(returnOrder && returnOrder.status==2){
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">填写退货信息</a><a href="javascript:void(0);">商家同意退货</a></div>';
					}else if(returnOrder && returnOrder.status==4){
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">售后详情</a><a href="javascript:void(0);">买家发出退货</a></div>';
					}else if(returnOrder && returnOrder.status==3){
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">售后详情 </a><a href="javascript:void(0);">商家拒绝退货</a></div>';
					}else if(result.status==15){
						html +='<div class="order_btn"><a href="javascript:void(0);">商家同意退款</a></div>';
					}else if(result.status==16){
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');" class="btn_ren">售后详情</a><a href="javascript:void(0);">商家拒绝退款</a></div>';
					}else if(result.status==-1){//关闭
						html +='<div class="order_btn"><a href="javascript:go2AfterOrderDetails(\''+result.subOrderId+'\');">订单已取消</a></div>';
					}
					$(".main-box").append(html);
					$(".order_xinxi").after('<div class="share"><a href="javascript:openEwm(\''+result.subOrderId+'\');" >订单二维码</a></div>');
				}
			}
		},
		error : function() {}
...
function openEwm(orderId){
	var url=jsBasePath+"order/orderDetailPageEx.user?subOrderId="+orderId;
...
function go2p(url){
	window.location = jsBasePath+'productm?productId='+url+'&from=a&pageKey=order';
}
